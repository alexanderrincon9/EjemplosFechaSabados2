...
//console.log(`la distancia del planeta Yavin4 a Naboo es de: ${distancia} UA`)
console.log(`la distancia del planeta Yavin4 a Naboo es de: ${Math.sqrt(sumaPotencias)} UA`)
console.log(`la distancia del planeta Yavin4 a Naboo es de: ${Math.sqrt(sumaPotencias)} UA`)
*/